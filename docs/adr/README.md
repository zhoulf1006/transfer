...
| [0013](0013-docs-lifecycle-by-rot-risk.md) | 文档体系按腐烂速度分类(本体系的元决策) | 已接受(第 3 项经 [ADR-0017](0017-spec-is-persistent-not-scratch.md)、[ADR-0019](0019-workings-replace-scratch.md) 两次修订) |
