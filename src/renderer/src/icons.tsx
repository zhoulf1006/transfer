...
/** Lucide radar —— 聊天空状态:尚未发现任何设备(搜索中) */
export function RadarIcon(props: { size?: number }): JSX.Element {
  return (
    <Icon size={props.size}>
...
/** Lucide message-circle —— 聊天空状态:已发现设备,等用户挑一个开始聊天 */
export function MessageCircleIcon(props: { size?: number }): JSX.Element {
  return (
    <Icon size={props.size}>
